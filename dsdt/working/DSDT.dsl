 ...
 * 
 * Disassembly of DSDT.aml, Mon Mar 16 18:34:19 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000BBE1 (48097)
 *     Revision         0x02
 *     Checksum         0xE8
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000014)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCB7FCC18, 0x02B4)
    ...
    OperationRegion (EXBU, SystemMemory, 0xCB7FFF18, 0x000D)
...
//                        Return(Arg0)
                    ...
                    CreateByteField (CRS1, \_SB.PCI0.LPCB.SIO1._Y17._MIN, IOLO)  // _MIN: Minimum Base Address
                    CreateByteField (CRS1, 0x03, IOHI)
                    CreateByteField (CRS1, \_SB.PCI0.LPCB.SIO1._Y17._MAX, IORL)  // _MAX: Maximum Base Address
                    CreateByteField (CRS1, 0x05, IORH)
                    CreateByteField (CRS1, \_SB.PCI0.LPCB.SIO1._Y17._LEN, LNA1)  // _LEN: Length
                    CreateWordField (CRS1, \_SB.PCI0.LPCB.SIO1._Y18._INT, IRQL)  // _INT: Interrupts
                    ...
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y19._MIN, IO2L)  // _MIN: Minimum Base Address
                    CreateByteField (CRS2, 0x03, IO2H)
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y19._MAX, IOL2)  // _MAX: Maximum Base Address
                    CreateByteField (CRS2, 0x05, IOH2)
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y19._LEN, DNA1)  // _LEN: Length
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1A._MIN, DALO)  // _MIN: Minimum Base Address
                    CreateByteField (CRS2, 0x0B, DAHI)
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1A._MAX, DRLO)  // _MAX: Maximum Base Address
                    CreateByteField (CRS2, 0x0D, DRHI)
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1A._LEN, DNA2)  // _LEN: Length
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1B._INT, IRQ2)  // _INT: Interrupts
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y1C._DMA, DMAC)  // _DMA: Direct Memory Access
                ...
                Device (HS13)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Name (PLDP, Package (0x01)
                        {
                            ...
                            {
                                /* 0000 */  0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                /* 0008 */  0x71, 0x1C, 0x80, 0x06, 0x00, 0x00, 0x00, 0x00 
                            }
                        })
                        CreateBitField (DerefOf (Index (PLDP, Zero)), 0x40, VIS)
                        If (LNot (And (PR2S (0x0D), PR2)))
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xCC844E18, 0x10)
        ...
        Method (SWAK, 1, NotSerialized)
        {
            ...
            If (LOr (LOr (LEqual (^^EHC1.PMEX, One), LEqual (^^EHC2.PMEX, One)), LEqual (
                ^^XHC.PMEX, One)))
            {
                Notify (PWRB, 0x02)
            }
    ...
    OperationRegion (CMSX, SystemIO, 0x72, 0x02)
    Field (CMSX, ByteAcc, NoLock, Preserve)
    {
        IDXX,   8, 
        DATX,   8
    }

    IndexField (IDXX, DATX, ByteAcc, NoLock, Preserve)
    {
        Offset (0x0F), 
        U2RT,   8
    }
...
//            Arg0
    ...
    Method (_PTS, 1, NotSerialized)  // _PTS: Prepare To Sleep
    {
        ...
        Store (Zero, Local2)
        Store (Zero, Local3)
        And (One, ShiftRight (GL02, 0x05, Local2), Local2)
        Or (And (0x02, ShiftRight (GL05, 0x05, Local3), Local3), Local2, Local2)
        Store (Zero, Local3)
        Or (And (0x04, ShiftRight (GL08, 0x02, Local3), Local3), Local2, Local2)
    ...
    {
        P8XH (One, 0xAB)
        OperationRegion (GPSI, SystemIO, 0x1C30, 0x04)
        Field (GPSI, ByteAcc, NoLock, Preserve)
        {
            GPS1,   8, 
            GPS2,   8, 
            GPS3,   8, 
    ...
    Scope (_GPE)
    {
        Device (AMW0)
        {
            ...
            {
                /* 0000 */  0x22, 0x48, 0x31, 0x02, 0x7C, 0x30, 0x66, 0x4F,
                /* 0008 */  0xBF, 0x0E, 0x48, 0xAE, 0xAE, 0xB2, 0x6C, 0xC8,
                /* 0010 */  0xD1, 0x00, 0x01, 0x08, 0x22, 0x48, 0x31, 0x02,
                /* 0018 */  0x7C, 0x30, 0x66, 0x4F, 0xBF, 0x0E, 0x48, 0xAE,
                /* 0020 */  0xAE, 0xB2, 0x6C, 0xC8, 0xD2, 0x00, 0x01, 0x08,
                /* 0028 */  0x22, 0x48, 0x31, 0x02, 0x7C, 0x30, 0x66, 0x4F,
                /* 0030 */  0xBF, 0x0E, 0x48, 0xAE, 0xAE, 0xB2, 0x6C, 0xC8,
                /* 0038 */  0xD3, 0x00, 0x01, 0x08, 0x22, 0x48, 0x31, 0x02,
                /* 0040 */  0x7C, 0x30, 0x66, 0x4F, 0xBF, 0x0E, 0x48, 0xAE,
                /* 0048 */  0xAE, 0xB2, 0x6C, 0xC8, 0xC4, 0x00, 0x01, 0x08,
                /* 0050 */  0x22, 0x48, 0x31, 0x02, 0x7C, 0x30, 0x66, 0x4F,
                /* 0058 */  0xBF, 0x0E, 0x48, 0xAE, 0xAE, 0xB2, 0x6C, 0xC8,
                /* 0060 */  0xC5, 0x00, 0x01, 0x08, 0x8F, 0x98, 0xE2, 0x96,
                /* 0068 */  0x4D, 0xE2, 0xAF, 0x49, 0x84, 0xE2, 0x7F, 0x3B,
                /* 0070 */  0xF7, 0x26, 0x02, 0xCD, 0x41, 0x41, 0x01, 0x00,
                /* 0078 */  0xE8, 0x3E, 0x70, 0x2D, 0xAC, 0x36, 0x88, 0x4F,
                /* 0080 */  0xBD, 0xB5, 0x75, 0x56, 0xCE, 0x6B, 0x29, 0x46,
                /* 0088 */  0x42, 0x43, 0x01, 0x02, 0x21, 0x12, 0x90, 0x05,
            ...
            Method (WMBC, 3, NotSerialized)
            {
                ...
                OperationRegion (BRLV, SystemIO, 0x72, 0x02)
                Field (BRLV, ByteAcc, NoLock, Preserve)
                {
                    INDX,   8, 
                    DATA,   8
                }
                ...
                If (LEqual (Arg1, One))
                {
                    If (LOr (LAnd (LGreaterEqual (OSVR, 0x09), LLessEqual (OSVR, 
                        0x0B)), LEqual (OSVR, 0x04)))
                    {
                        Store (0x4A, INDX)
                        If (LEqual (DATA, 0xAA))
                        {
            ...
            Name (WQMO, Buffer (0x071E)
            {
                /* 0000 */  0x46, 0x4F, 0x4D, 0x42, 0x01, 0x00, 0x00, 0x00,
                /* 0008 */  0x0E, 0x07, 0x00, 0x00, 0x48, 0x25, 0x00, 0x00,
                /* 0010 */  0x44, 0x53, 0x00, 0x01, 0x1A, 0x7D, 0xDA, 0x54,
                /* 0018 */  0x28, 0x55, 0x92, 0x00, 0x01, 0x06, 0x18, 0x42,
                ...
                /* 0070 */  0xA4, 0x0B, 0x42, 0x4A, 0x05, 0xF8, 0x46, 0xD0,
                /* 0078 */  0x00, 0xA2, 0x9C, 0x04, 0x23, 0xB0, 0xD4, 0x21,
                /* 0080 */  0xA0, 0xE4, 0x0C, 0x01, 0x35, 0x80, 0x56, 0x27,
                /* 0088 */  0x20, 0xFC, 0xD0, 0xA7, 0x84, 0x23, 0x08, 0x67,
                /* 0090 */  0xAC, 0xE2, 0x67, 0x20, 0xE5, 0x02, 0x4C, 0xCF,
                /* 0098 */  0x49, 0xCE, 0x31, 0xE4, 0x78, 0x5C, 0xE8, 0x41,
                /* 00A0 */  0xF0, 0x58, 0xA3, 0x45, 0x05, 0x19, 0x30, 0x3A,
                /* 00A8 */  0x04, 0x84, 0x14, 0x0C, 0x18, 0x64, 0x10, 0x27,
                /* 00B0 */  0x72, 0x20, 0x45, 0x4F, 0x50, 0x92, 0x07, 0x0C,
                /* 00B8 */  0x54, 0x46, 0xC0, 0xE3, 0x3D, 0x0E, 0x08, 0x41,
                /* 00C0 */  0xF9, 0xA7, 0x03, 0x05, 0x82, 0x41, 0x49, 0x18,
                /* 00C8 */  0x36, 0x75, 0x31, 0x40, 0x14, 0x3E, 0x9F, 0x4C,
                /* 00D0 */  0x88, 0xD2, 0xA0, 0xE8, 0xFF, 0x7F, 0x80, 0x7C,
                /* 00D8 */  0x76, 0x27, 0x72, 0xD0, 0x0D, 0x0B, 0x90, 0x3D,
                /* 00E0 */  0x37, 0x11, 0x18, 0xF5, 0x94, 0x0E, 0xA6, 0xB0,
                /* 00E8 */  0xC9, 0x0B, 0x35, 0x46, 0x73, 0x50, 0x24, 0xDC,
                /* 00F0 */  0xF8, 0xD0, 0x12, 0x61, 0x75, 0x04, 0x88, 0xFD,
                /* 00F8 */  0x12, 0x60, 0xE1, 0x03, 0x13, 0xC6, 0x11, 0x3C,
                /* 0100 */  0x03, 0x3C, 0x17, 0x78, 0xAE, 0x61, 0xA2, 0x15,
                /* 0108 */  0x04, 0xA7, 0x41, 0x1C, 0x45, 0x94, 0x30, 0x0C,
                /* 0110 */  0xCF, 0x98, 0x81, 0x1E, 0x08, 0x18, 0xD2, 0x59,
                /* 0118 */  0x7B, 0x02, 0x41, 0x0E, 0x3B, 0x46, 0xCD, 0x58,
                /* 0120 */  0x04, 0xE2, 0x0C, 0x38, 0x56, 0x8C, 0x50, 0x21,
                /* 0128 */  0x31, 0x03, 0x09, 0x7E, 0x02, 0x5D, 0x63, 0xC8,
                /* 0130 */  0x33, 0x10, 0xB1, 0x3E, 0x01, 0x81, 0x44, 0x8F,
                /* 0138 */  0x12, 0xDC, 0xB8, 0x46, 0x65, 0x63, 0x3A, 0x1B,
                /* 0140 */  0xDC, 0xC0, 0x4C, 0x10, 0xE7, 0xF0, 0x30, 0x32,
                /* 0148 */  0x20, 0x34, 0x81, 0xF8, 0xB1, 0xDF, 0x09, 0x4C,
                /* 0150 */  0xD0, 0xBD, 0x00, 0x65, 0x02, 0xB4, 0x21, 0x68,
                /* 0158 */  0xA6, 0xB6, 0x86, 0x20, 0x6F, 0x02, 0x6C, 0x21,
                /* 0160 */  0xC9, 0x99, 0x00, 0x85, 0x50, 0x42, 0x89, 0x15,
                /* 0168 */  0xCA, 0x1A, 0x51, 0x04, 0xF4, 0xB2, 0xF0, 0x54,
                /* 0170 */  0x10, 0x26, 0xCA, 0x7B, 0x41, 0x84, 0x30, 0x8D,
                /* 0178 */  0x21, 0x08, 0x2C, 0x52, 0x88, 0xE3, 0x0E, 0xF1,
                /* 0180 */  0x70, 0x10, 0xA3, 0xFD, 0x41, 0x10, 0x49, 0x16,
                /* 0188 */  0x4E, 0x20, 0x4C, 0xD4, 0x89, 0x40, 0x46, 0xB6,
                /* 0190 */  0x94, 0x80, 0x9C, 0x14, 0x7C, 0x12, 0xF0, 0x08,
                /* 0198 */  0x9A, 0x9F, 0x99, 0x46, 0xE5, 0xC3, 0x42, 0xFC,
                /* 01A0 */  0x27, 0x03, 0x41, 0x0A, 0x96, 0x9C, 0x42, 0x28,
                /* 01A8 */  0x81, 0xA5, 0x1C, 0x0D, 0x88, 0xED, 0x81, 0xE9,
                /* 01B0 */  0x1E, 0x70, 0x84, 0xE7, 0xEE, 0xCB, 0xC1, 0xA9,
                /* 01B8 */  0xF9, 0x53, 0xE2, 0x3D, 0xF8, 0x90, 0xC0, 0x87,
                /* 01C0 */  0xE8, 0xB1, 0x1E, 0x43, 0xC0, 0x43, 0x64, 0xA7,
                /* 01C8 */  0x04, 0x03, 0xE2, 0xBD, 0x5F, 0x0B, 0xC8, 0x64,
                /* 01D0 */  0x0C, 0xC8, 0x4E, 0x0A, 0x0F, 0x08, 0x30, 0xFE,
                /* 01D8 */  0xFF, 0x07, 0x04, 0x38, 0xE3, 0x3A, 0xDE, 0x63,
                /* 01E0 */  0xA8, 0x78, 0x6E, 0x88, 0x33, 0x01, 0x9F, 0xCA,
                /* 01E8 */  0x49, 0xB1, 0xD3, 0x08, 0x1F, 0x1D, 0x1F, 0x85,
                /* 01F0 */  0x0F, 0x0F, 0x67, 0x5D, 0xEC, 0x19, 0x82, 0xCA,
                /* 01F8 */  0x3A, 0x47, 0xA0, 0xE7, 0xFD, 0xC6, 0xE1, 0x5B,
                /* 0200 */  0x43, 0xB3, 0xD7, 0x12, 0x42, 0xF0, 0x3E, 0xE0,
                /* 0208 */  0x2B, 0x83, 0x4F, 0x20, 0x1E, 0x3A, 0xFC, 0x33,
                /* 0210 */  0xC1, 0xA1, 0x83, 0xED, 0x5C, 0xE2, 0xA1, 0x03,
                /* 0218 */  0xCE, 0x2F, 0x17, 0x87, 0x0E, 0x36, 0x40, 0xEF,
                /* 0220 */  0xC1, 0xFF, 0xFF, 0xA1, 0x03, 0xBE, 0x8F, 0x3B,
                /* 0228 */  0x1E, 0x3A, 0xB8, 0x8E, 0x40, 0x1E, 0x3A, 0xE0,
                /* 0230 */  0xF4, 0xC0, 0xC4, 0xFF, 0xFF, 0x07, 0x2C, 0xB8,
                /* 0238 */  0xD8, 0x4F, 0x43, 0xB8, 0xF3, 0x15, 0x30, 0x8A,
                /* 0240 */  0xF0, 0x0E, 0x30, 0x81, 0x62, 0x1C, 0x0A, 0x24,
                /* 0248 */  0x1A, 0x06, 0x75, 0x2E, 0xF0, 0xF9, 0x0A, 0xEE,
                /* 0250 */  0xDF, 0x4E, 0x70, 0x88, 0xF1, 0xF9, 0x10, 0x70,
                /* 0258 */  0xF2, 0x87, 0x79, 0x66, 0xEF, 0x07, 0x1E, 0xDC,
                /* 0260 */  0x83, 0x16, 0x8C, 0x73, 0x82, 0xA7, 0xF5, 0x2E,
                /* 0268 */  0x70, 0x48, 0xEF, 0x6A, 0x8F, 0x4B, 0xBE, 0x39,
                /* 0270 */  0x99, 0xC0, 0x87, 0x05, 0x86, 0xC6, 0x4F, 0x5D,
                /* 0278 */  0x60, 0x3D, 0x20, 0x3C, 0x27, 0x80, 0xC5, 0xE3,
                /* 0280 */  0xB1, 0x4E, 0x03, 0x8C, 0xF7, 0x92, 0x65, 0xA4,
                /* 0288 */  0x18, 0x8D, 0xDE, 0x09, 0x34, 0x24, 0x4F, 0xAF,
                /* 0290 */  0xAF, 0x59, 0xE8, 0xE2, 0x66, 0xA8, 0x47, 0x8B,
                /* 0298 */  0x88, 0x7D, 0xE2, 0x08, 0x25, 0xC4, 0xC3, 0x82,
                /* 02A0 */  0xF1, 0x3D, 0x85, 0x17, 0x2D, 0x76, 0x64, 0x88,
                /* 02A8 */  0x9D, 0xC0, 0x67, 0x2C, 0xD8, 0xA3, 0x7A, 0x81,
                /* 02B0 */  0x78, 0x1F, 0x78, 0xFA, 0x09, 0xF2, 0xA4, 0x10,
                /* 02B8 */  0xE1, 0xF1, 0xCA, 0x38, 0x9E, 0xDB, 0xE1, 0x3C,
                /* 02C0 */  0x63, 0x19, 0xEB, 0xBD, 0x20, 0x94, 0xD1, 0xC2,
                /* 02C8 */  0x04, 0x33, 0xCA, 0xBB, 0xD6, 0xFF, 0x3F, 0xD0,
                /* 02D0 */  0xB3, 0x96, 0x31, 0xA2, 0x3C, 0x72, 0x79, 0x96,
                /* 02D8 */  0x31, 0x1E, 0x10, 0xE2, 0x3E, 0x63, 0xB1, 0xB8,
                /* 02E0 */  0x6F, 0x20, 0xFD, 0xB1, 0x24, 0x20, 0xD2, 0x68,
                /* 02E8 */  0x50, 0xA7, 0x05, 0x9F, 0x0B, 0x3C, 0xB5, 0x27,
                /* 02F0 */  0x34, 0xCF, 0xCC, 0x20, 0x47, 0x76, 0x80, 0x4F,
                /* 02F8 */  0x0C, 0x0F, 0x04, 0x1E, 0x3A, 0xBB, 0x03, 0xFA,
                /* 0300 */  0x64, 0xE1, 0x13, 0x02, 0xFE, 0x0A, 0x11, 0xF0,
                /* 0308 */  0x60, 0x9F, 0x3E, 0x60, 0x9D, 0x42, 0xF0, 0x53,
                /* 0310 */  0x7A, 0xC6, 0x80, 0x3D, 0x1E, 0x5F, 0x11, 0xD9,
                /* 0318 */  0x84, 0x9F, 0xF6, 0xC8, 0x20, 0x50, 0xC7, 0x15,
                /* 0320 */  0x3E, 0xD7, 0xD3, 0x7A, 0x02, 0xF0, 0x49, 0xD1,
                /* 0328 */  0x04, 0x3E, 0x7A, 0xF8, 0xE0, 0x04, 0x8E, 0xF1,
                /* 0330 */  0xC0, 0xBF, 0x98, 0x3C, 0x65, 0xF8, 0xD6, 0xE0,
                /* 0338 */  0xF9, 0xFA, 0xF8, 0xA0, 0xD3, 0x8C, 0xC7, 0x83,
                /* 0340 */  0x1A, 0x88, 0xCF, 0x08, 0xFC, 0xDE, 0xF1, 0xC2,
                /* 0348 */  0xF1, 0xDE, 0x61, 0x90, 0xC7, 0x18, 0x7E, 0x5E,
                /* 0350 */  0x63, 0x8F, 0x34, 0x9F, 0x03, 0x7C, 0x5E, 0x03,
                /* 0358 */  0x9E, 0xA8, 0x3E, 0x5A, 0xC0, 0xF9, 0xFF, 0x1F,
                /* 0360 */  0x2D, 0xF0, 0x73, 0x7B, 0xA6, 0xF0, 0x29, 0x22,
                /* 0368 */  0xD8, 0x5B, 0xA0, 0xEF, 0x83, 0xFC, 0x7C, 0xC8,
                /* 0370 */  0xCF, 0x9E, 0xEC, 0x5A, 0x83, 0x99, 0xD0, 0xDB,
                /* 0378 */  0x85, 0x0F, 0x37, 0xEC, 0x40, 0x03, 0xB6, 0x03,
                /* 0380 */  0x28, 0x38, 0x0E, 0x08, 0x1E, 0x57, 0xE8, 0x58,
                /* 0388 */  0xAF, 0x00, 0x9E, 0xDC, 0x03, 0x2C, 0x70, 0x19,
                /* 0390 */  0x01, 0x0F, 0x7F, 0x9C, 0xA1, 0x71, 0x5E, 0x02,
                /* 0398 */  0x8A, 0x0B, 0x83, 0x3A, 0xD1, 0x00, 0xAE, 0x02,
                /* 03A0 */  0x9C, 0x13, 0x40, 0x33, 0xEB, 0x77, 0x52, 0x18,
                /* 03A8 */  0xFF, 0xFF, 0x3B, 0x29, 0x3B, 0x82, 0x30, 0xAC,
                /* 03B0 */  0xE0, 0x0F, 0xBD, 0x1C, 0xE6, 0x69, 0xC9, 0x28,
                /* 03B8 */  0x87, 0xE6, 0x33, 0x85, 0xCF, 0xA2, 0xEC, 0x82,
                /* 03C0 */  0x80, 0xB9, 0x55, 0xE1, 0x4E, 0x35, 0xB0, 0x4F,
                /* 03C8 */  0x31, 0x3E, 0xC9, 0x3C, 0x6D, 0x1C, 0x5C, 0xEC,
                /* 03D0 */  0x28, 0x6F, 0x33, 0xC6, 0x09, 0xF5, 0x30, 0x73,
                /* 03D8 */  0x4E, 0x4F, 0x35, 0xBE, 0xCE, 0xBC, 0x8F, 0xFA,
                /* 03E0 */  0x20, 0x6A, 0x94, 0x58, 0x6F, 0x07, 0xA1, 0x0C,
                /* 03E8 */  0xFA, 0x82, 0x10, 0x25, 0x84, 0xB1, 0xDE, 0x6A,
                /* 03F0 */  0x8C, 0x1A, 0x21, 0xD4, 0x53, 0x0D, 0x13, 0xF8,
                /* 03F8 */  0xF6, 0xD0, 0xB9, 0xC0, 0xA7, 0x1A, 0x80, 0x1F,
                /* 0400 */  0x22, 0x4F, 0x18, 0x72, 0x32, 0x70, 0x34, 0x68,
                /* 0408 */  0xEC, 0x87, 0x1A, 0xFC, 0xFF, 0xFF, 0x50, 0xC3,
                /* 0410 */  0xC5, 0x1C, 0x6A, 0x80, 0xEE, 0x01, 0xE3, 0xA1,
                /* 0418 */  0x06, 0x78, 0xCD, 0x14, 0xEE, 0x11, 0x00, 0x0C,
                /* 0420 */  0x17, 0x0D, 0x7E, 0xB2, 0x78, 0x9D, 0xF5, 0xB0,
                /* 0428 */  0x7C, 0xB4, 0x01, 0x23, 0xC8, 0x23, 0x08, 0xE6,
                /* 0430 */  0x74, 0x03, 0x5C, 0xC6, 0x84, 0x3B, 0xED, 0x83,
                /* 0438 */  0xE3, 0x7C, 0xC0, 0x4E, 0xFA, 0xB0, 0xE4, 0x2A,
                /* 0440 */  0x01, 0x61, 0xFF, 0xFF, 0xC3, 0xA0, 0x43, 0x3C,
                /* 0448 */  0x16, 0xE8, 0x79, 0x10, 0xF0, 0x7A, 0xDC, 0xC1,
                /* 0450 */  0x1D, 0xDF, 0x31, 0x47, 0x42, 0x06, 0x11, 0xF5,
                /* 0458 */  0x49, 0x07, 0x03, 0xF4, 0xF0, 0xE2, 0x9B, 0x84,
                /* 0460 */  0xC1, 0x42, 0xFA, 0x4E, 0x13, 0xE2, 0x7C, 0x7D,
                /* 0468 */  0xA4, 0x39, 0x82, 0x47, 0x78, 0x30, 0x0C, 0xE8,
                /* 0470 */  0x2D, 0xE7, 0xB8, 0x5E, 0x1F, 0x5E, 0x06, 0x22,
                /* 0478 */  0x3C, 0xDC, 0x3C, 0xEA, 0xF8, 0x7C, 0xF3, 0x98,
                /* 0480 */  0xE0, 0xA3, 0x0E, 0xBB, 0x14, 0xFA, 0xA8, 0x63,
                /* 0488 */  0xCC, 0x10, 0x8F, 0xF0, 0x86, 0x7D, 0x8E, 0xF7,
                /* 0490 */  0x3D, 0xC7, 0xB8, 0x31, 0x5E, 0x75, 0x3C, 0xCB,
                /* 0498 */  0xA0, 0x51, 0x1E, 0x75, 0x58, 0xFC, 0x43, 0x09,
                /* 04A0 */  0x3D, 0xEA, 0x00, 0xBF, 0xFF, 0xFF, 0x51, 0x07,
                /* 04A8 */  0x10, 0x78, 0x30, 0x01, 0xD5, 0xBD, 0x84, 0xDF,
                /* 04B0 */  0x11, 0x8C, 0xF1, 0xAA, 0x80, 0x3B, 0x99, 0x00,
                /* 04B8 */  0x77, 0x74, 0x43, 0x1C, 0x13, 0x2E, 0xA0, 0x8E,
                /* 04C0 */  0x23, 0x09, 0x0B, 0xB1, 0x78, 0xD9, 0x38, 0x63,
                /* 04C8 */  0xD3, 0x23, 0x88, 0x05, 0x9F, 0x1A, 0x74, 0x84,
                /* 04D0 */  0x8D, 0xEA, 0x5B, 0x0F, 0xEE, 0xEC, 0x21, 0x30,
                /* 04D8 */  0x9D, 0x8A, 0x0C, 0x61, 0x81, 0x14, 0x92, 0x07,
                /* 04E0 */  0xA1, 0xE1, 0x18, 0xDC, 0x82, 0xE0, 0x28, 0x88,
                /* 04E8 */  0x0F, 0x04, 0x0E, 0x0B, 0xA1, 0x63, 0x13, 0xEE,
                /* 04F0 */  0xFF, 0x3F, 0x7A, 0xCF, 0x81, 0x69, 0xBD, 0x8B,
                /* 04F8 */  0x10, 0x02, 0x47, 0x3B, 0x6E, 0xD3, 0x13, 0x04,
                /* 0500 */  0x7E, 0x5E, 0x27, 0xF3, 0x20, 0xE1, 0x69, 0x78,
                /* 0508 */  0xA8, 0xB8, 0x03, 0x12, 0x98, 0x46, 0xC2, 0xAE,
                /* 0510 */  0xBB, 0x3E, 0x63, 0xC3, 0x39, 0xF8, 0x9A, 0x80,
                /* 0518 */  0x1F, 0x8D, 0xC0, 0x27, 0xF0, 0xC8, 0x00, 0x0A,
                /* 0520 */  0x20, 0xDF, 0x10, 0x7C, 0x6E, 0x62, 0x33, 0x38,
                /* 0528 */  0x87, 0x87, 0x02, 0x1F, 0x09, 0xD8, 0xE1, 0x06,
                /* 0530 */  0x71, 0x1C, 0xA1, 0x67, 0x4C, 0x8F, 0x8B, 0x0F,
                /* 0538 */  0xD4, 0x87, 0x1B, 0x76, 0x34, 0xC0, 0x9D, 0xB9,
                /* 0540 */  0x30, 0xB0, 0x1E, 0x3A, 0x87, 0x35, 0x5A, 0xD8,
                /* 0548 */  0x23, 0x7E, 0xB2, 0xF0, 0x49, 0xC2, 0x47, 0x2B,
                /* 0550 */  0x06, 0xEB, 0xF3, 0x08, 0x38, 0x8E, 0x5F, 0xF0,
                /* 0558 */  0x0F, 0x04, 0x3E, 0x4C, 0x83, 0xE5, 0x14, 0xCD,
                /* 0560 */  0x2E, 0x5F, 0x7C, 0x28, 0x3E, 0x12, 0x60, 0x6E,
                /* 0568 */  0x25, 0x8F, 0x04, 0xFC, 0xFF, 0x7F, 0xFD, 0xE2,
                /* 0570 */  0xA0, 0x1C, 0x26, 0xD6, 0x5B, 0x8C, 0xA7, 0x80,
                /* 0578 */  0x39, 0x9A, 0xEB, 0x48, 0x01, 0xE5, 0x74, 0xCD,
                /* 0580 */  0x2E, 0xEE, 0x3E, 0xFF, 0x78, 0xA8, 0x09, 0x7C,
                /* 0588 */  0xA4, 0x00, 0xDF, 0xE9, 0x17, 0x77, 0x3A, 0xF0,
                /* 0590 */  0x31, 0xC7, 0x93, 0xC0, 0x1D, 0x29, 0xE0, 0x5D,
                /* 0598 */  0x17, 0x3C, 0x78, 0x7E, 0x3C, 0xC1, 0x0F, 0x1A,
                /* 05A0 */  0xDE, 0x38, 0x0C, 0xF4, 0x80, 0xE1, 0x25, 0x1E,
                /* 05A8 */  0x09, 0x66, 0x84, 0xBE, 0x54, 0xB1, 0x33, 0x05,
                /* 05B0 */  0xDC, 0x63, 0x2E, 0xB8, 0x8E, 0x14, 0xC0, 0x43,
                /* 05B8 */  0xC8, 0x91, 0x02, 0x74, 0xA7, 0x00, 0x1F, 0x29,
                /* 05C0 */  0xC0, 0xF9, 0xFF, 0x3F, 0x52, 0x80, 0xF7, 0x3C,
                /* 05C8 */  0x06, 0x9E, 0x73, 0x3E, 0x3F, 0x48, 0x70, 0xB8,
                /* 05D0 */  0xE7, 0x01, 0xFC, 0x41, 0x9F, 0xDD, 0xC9, 0xD8,
                /* 05D8 */  0x8D, 0x02, 0xA6, 0xE8, 0x13, 0x05, 0xC4, 0x3B,
                /* 05E0 */  0xD2, 0x69, 0xB1, 0x83, 0xD0, 0x51, 0xF9, 0xCC,
                /* 05E8 */  0x03, 0xF0, 0xE5, 0xFF, 0x7F, 0xA2, 0x80, 0x1B,
                /* 05F0 */  0x1D, 0x42, 0x27, 0x0A, 0x70, 0x41, 0xFA, 0x44,
                /* 05F8 */  0x01, 0x5C, 0x47, 0xF7, 0x44, 0x01, 0xD6, 0xCB,
                /* 0600 */  0x03, 0x3B, 0xDF, 0xC5, 0x89, 0xF4, 0xA2, 0xED,
                /* 0608 */  0x6B, 0x23, 0x3B, 0x40, 0x30, 0xE1, 0x47, 0x09,
                /* 0610 */  0xD4, 0x28, 0x2C, 0xF9, 0x28, 0x01, 0x61, 0x26,
                /* 0618 */  0x67, 0x71, 0x4A, 0x8F, 0x63, 0x80, 0xC7, 0xFF,
                /* 0620 */  0xFF, 0x59, 0x02, 0xF0, 0x10, 0xFE, 0x2C, 0x01,
                /* 0628 */  0xBA, 0xA1, 0xFB, 0x2C, 0x01, 0x5C, 0x0F, 0x98,
                /* 0630 */  0x3E, 0x4B, 0x00, 0x93, 0x13, 0x04, 0x46, 0xF6,
                /* 0638 */  0x61, 0x02, 0x75, 0x2C, 0xB0, 0xE8, 0xC3, 0x04,
                /* 0640 */  0x62, 0xB4, 0x27, 0xE1, 0x11, 0x19, 0xE4, 0x08,
                /* 0648 */  0x9E, 0x2F, 0x9F, 0x7A, 0x22, 0x3C, 0x4D, 0x00,
                /* 0650 */  0xA3, 0xFF, 0xFF, 0x69, 0x02, 0x70, 0x1F, 0xFC,
                /* 0658 */  0x34, 0x01, 0x3A, 0x58, 0x7E, 0x9A, 0x00, 0x9E,
                /* 0660 */  0x03, 0x7C, 0x9A, 0x00, 0x2B, 0x50, 0x48, 0xA3,
                /* 0668 */  0x1C, 0x94, 0x71, 0x5E, 0x1F, 0xF8, 0x09, 0x0C,
                /* 0670 */  0x7B, 0x96, 0xE0, 0xFF, 0xFF, 0xB3, 0x04, 0xAC,
                /* 0678 */  0x83, 0x20, 0x3B, 0x4B, 0x00, 0x5C, 0x8A, 0x7D,
                /* 0680 */  0x96, 0x00, 0xDD, 0x81, 0xD9, 0x67, 0x09, 0xE0,
                /* 0688 */  0xF8, 0xFF, 0x3F, 0x4B, 0xF0, 0x39, 0x3E, 0x4B,
                /* 0690 */  0x00, 0x0B, 0x48, 0x2B, 0xB4, 0xE9, 0x53, 0xA3,
                /* 0698 */  0x51, 0xAB, 0x06, 0x65, 0x6A, 0x94, 0x69, 0x50,
                /* 06A0 */  0xAB, 0x4F, 0xA5, 0xC6, 0x8C, 0x1D, 0x0A, 0x1C,
                /* 06A8 */  0xF9, 0xE5, 0xA0, 0xC3, 0x83, 0xA5, 0x3E, 0x18,
                /* 06B0 */  0x34, 0x60, 0xCB, 0x5F, 0xB3, 0x40, 0x1C, 0x69,
                /* 06B8 */  0xA9, 0x02, 0x71, 0x4C, 0x0F, 0x20, 0x2C, 0x98,
                /* 06C0 */  0x09, 0x50, 0x16, 0x46, 0x05, 0x10, 0x93, 0xB2,
                /* 06C8 */  0x3A, 0x81, 0x58, 0xE6, 0xEA, 0x04, 0x62, 0x89,
                /* 06D0 */  0xE7, 0x6E, 0x9D, 0x86, 0x89, 0x0F, 0x20, 0x16,
                /* 06D8 */  0x0A, 0x84, 0x06, 0x7F, 0x17, 0xE8, 0x40, 0x47,
                /* 06E0 */  0x5E, 0x14, 0x02, 0xB4, 0x94, 0x97, 0xA3, 0x80,
                /* 06E8 */  0x1C, 0x04, 0x84, 0xCA, 0xD7, 0x72, 0x98, 0x65,
                /* 06F0 */  0x61, 0x40, 0x04, 0x64, 0x11, 0x66, 0x80, 0x98,
                /* 06F8 */  0x24, 0x10, 0x01, 0x39, 0x84, 0x1B, 0x20, 0x16,
                /* 0700 */  0x09, 0x44, 0x40, 0x8E, 0x6E, 0x07, 0x88, 0x09,
                /* 0708 */  0xD1, 0x03, 0xC4, 0x44, 0x3F, 0x00, 0x04, 0xE4,
                /* 0710 */  0x08, 0x20, 0x02, 0x72, 0x54, 0x45, 0x40, 0x2C,
                /* 0718 */  0x38, 0x88, 0x80, 0xFC, 0xFF, 0x07             
            })
        }
        ...
        OperationRegion (SMRG, SystemIO, 0xF040, 0x10)
